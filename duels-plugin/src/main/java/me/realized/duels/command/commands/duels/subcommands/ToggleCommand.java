...
public class ToggleCommand extends BaseCommand {
    ...
    public ToggleCommand(final DuelsPlugin plugin) {
        super(plugin, "toggle", "toggle [name]",
                "Enables or disables an arena.", 2, false);
    }
    ...
    protected void execute(final CommandSender sender, final String label, final String[] args) {
        ...
        lang.sendMessage(sender, "COMMAND.duels.toggle", "name", name, "state", arena.isDisabled() ?
                lang.getMessage("GENERAL.disabled") : lang.getMessage("GENERAL.enabled"));
    }
